...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>赠送数量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.giftQuantity}" placeholder="" id="giftQuantity" name="giftQuantity" onInput="intInit(this)">
            </div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Gift：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if gifts??]
				<select name="giftId" class="select" style="background-color: #FFFFFF">
                    [#list gifts as gift]
					<option[#if data.gift?? && gift.id == data.gift.id] selected[/#if] value="${gift.id}">${gift.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Goods：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if goodss??]
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/promotion/update.jhtml" ,
                            beforeSend: function() {
