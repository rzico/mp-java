...
<head>
    ...
    <style type="text/css">
        .desktop {
            ...
            left:0;
            right:0;
            background: url('${base}/resources/admin/images/desktop.jpg') repeat;
        ...
        .button {
            ...
            width:116px;
            height:30px;
            background: url('${base}/resources/admin/images/download.png') repeat;
            background-size: cover;
        }
        .button:hover {
            background: url('${base}/resources/admin/images/download_hover.png') repeat;
            background-size: cover;
        }
    </style>
</head>
