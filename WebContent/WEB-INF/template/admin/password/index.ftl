...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" name="oldPassword" value="" placeholder="" id="oldPassword" >
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" name="newPassword" value="" placeholder="" id="newPassword" >
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" name="cfmPassword" value="" placeholder="" id="cfmPassword" >
            </div>
        </div>
            ...
            $(function(){
                ...
                $("#form-add").validate({
                    ...
                    submitHandler:function(form){
                        var load = layer.msg('执行中', {
                            icon: 16
                            ,shade: 0.01
                        });
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/password/update.jhtml" ,
                            beforeSend: function() {
