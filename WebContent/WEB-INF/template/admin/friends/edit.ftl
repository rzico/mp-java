...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">好友：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if friends??]
				<select name="friendId" class="select" style="background-color: #FFFFFF">
                    [#list friends as friend]
					<option[#if data.friend?? && friend.id == data.friend.id] selected[/#if] value="${friend.id}">${friend.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">自已：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if members??]
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/friends/update.jhtml" ,
                            beforeSend: function() {
