...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 金币兑换 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<script type="text/javascript">
    ...
    $(function () {
        $('.table').DataTable({
            ...
            "sAjaxSource": "${base}/admin/goldExchange/list.jhtml",
...
//   表格自适应屏幕
    ...
    /*删除全部*/
    function delAll(){
        var url = "${base}/admin/goldExchange/delete.jhtml";
        var i = 0;
    ...
    function del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            ...
            $.ajax({
                ...
                url: '${base}/admin/goldExchange/delete.jhtml',
                dataType: 'json',
                success: function (data) {
                    layer.close(load);
                    if (data.type == "success") {
