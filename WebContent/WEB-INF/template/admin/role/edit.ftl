...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否内置：</label>
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                    <input type="checkbox" name="isSystem" id="isSystem" value="true"[#if data.isSystem?? && data.isSystem] checked[/#if]>
                    <input type="hidden" name="_isSystem" value="false" />
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/role/update.jhtml" ,
                            beforeSend: function() {
