...
<head>
    ...
    <title>GaugeQuestion</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> GaugeQuestion <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
