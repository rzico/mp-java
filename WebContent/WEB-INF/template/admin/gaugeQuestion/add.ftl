...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="strLen" value="" placeholder="" id="strLen" onInput="intInit(this)">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="stayTime" value="" placeholder="请输入秒数" id="stayTime" onInput="intInit(this)">
            </div>
        </div>
