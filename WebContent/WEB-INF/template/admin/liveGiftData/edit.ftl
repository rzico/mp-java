...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        [#if data??]
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">礼物名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.giftName}" placeholder="" id="giftName" name="giftName">
            </div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">礼物价值：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">LiveGift：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if liveGifts??]
				<select name="liveGiftId" class="select" style="background-color: #FFFFFF">
                    [#list liveGifts as liveGift]
					<option[#if data.liveGift?? && liveGift.id == data.liveGift.id] selected[/#if] value="${liveGift.id}">${liveGift.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/liveGiftData/update.jhtml" ,
                            beforeSend: function() {
