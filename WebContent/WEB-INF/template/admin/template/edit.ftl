...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否默认：</label>
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                    <input type="checkbox" name="isDefault" id="isDefault" value="true"[#if data.isDefault?? && data.isDefault] checked[/#if]>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                    <input type="checkbox" name="isFreed" id="isFreed" value="true"[#if data.isFreed?? && data.isFreed] checked[/#if]>
                    <input type="hidden" name="_isFreed" value="false" />
                    <label for="isFreed">&nbsp;</label>
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>模板编号：</label>
            <div class="formControls col-xs-8 col-sm-9">
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/template/update.jhtml" ,
                            beforeSend: function() {
