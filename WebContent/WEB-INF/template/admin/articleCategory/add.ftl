...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="seoDescription" name="seoDescription">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="seoKeywords" name="seoKeywords">
            </div>
        </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="check-box">
					<label class=""><input type="checkbox" value="${article.id}" name="articleIds" >${article.name}</label>
				</div>
				[/#list]
				[/#if]
			</div>
            ...
            $(function(){
                ...
                $("#form-add").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/articleCategory/save.jhtml" ,
                            beforeSend: function() {
