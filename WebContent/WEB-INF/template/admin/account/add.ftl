    ...
    <form action="" method="post" class="form form-horizontal" id="form-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss' })" value="" id="settleDate" name="settleDate" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
            ...
            $(function(){
                ...
                $("#form-add").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/account/save.jhtml" ,
                            beforeSend: function() {
