...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 登录账号 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div class="page-container">
    <div class=""> 日期范围：
        ...
        <span class="select-box"  style="background-color: #FFFFFF;width:100px;height:32px;">
			<select name="gender" class="select" style="background-color: #FFFFFF;">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a href="javascript:;" onclick="add('首页 &gt; 登录账号 &gt; 新增','add.jhtml','','510')" class="btn btn-primary radius"><i
...
//   表格自适应屏幕
    ...
    /*删除全部*/
    function delAll(){
        var url = "${base}/admin/admin/delete.jhtml";
        var i = 0;
