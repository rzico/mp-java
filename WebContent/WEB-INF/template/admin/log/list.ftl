        ...
        $('.table').DataTable({
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    ...
                    "mRender": function (data, display, row) {
                        if(data != null){
                            return "<a title='详情' href='javascript:;' onclick=\"edit('首页 &gt; 日志管理 &gt; 详情','edit.jhtml?id=" + data + "','200" + data + "','510')\" class=\"ml-5\" style='text-decoration:none'>详情</a>"
//                                    +
