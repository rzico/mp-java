...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">LiveMember：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if liveMembers??]
				<select name="liveMemberId" class="select" style="background-color: #FFFFFF">
                    [#list liveMembers as liveMember]
					<option[#if data.liveMember?? && liveMember.id == data.liveMember.id] selected[/#if] value="${liveMember.id}">${liveMember.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/liveGroup/update.jhtml" ,
                            beforeSend: function() {
