...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.sex}" placeholder="" id="sex" name="sex">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.worry}" placeholder="" id="worry" name="worry">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Counselor：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if counselors??]
				<select name="counselorId" class="select" style="background-color: #FFFFFF">
                    [#list counselors as counselor]
					<option[#if data.counselor?? && counselor.id == data.counselor.id] selected[/#if] value="${counselor.id}">${counselor.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/subscribe/update.jhtml" ,
                            beforeSend: function() {
