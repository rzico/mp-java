...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">ForArticleReview：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if forArticleReviews??]
				<select name="forArticleReviewId" class="select" style="background-color: #FFFFFF">
                    [#list forArticleReviews as forArticleReview]
					<option[#if data.forArticleReview?? && forArticleReview.id == data.forArticleReview.id] selected[/#if] value="${forArticleReview.id}">${forArticleReview.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/articleReview/update.jhtml" ,
                            beforeSend: function() {
