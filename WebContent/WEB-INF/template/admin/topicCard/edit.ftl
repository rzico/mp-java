...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
                    ...
                    <div id="fileList" class="uploader-list">
                        [#if data.background??]
                            <div class="file-item thumbnail">
                                <img width="100px" height="100px" src="${data.background}"/>
                                <div class="info"></div>
                            </div>'
                        [/#if]
                    </div>
                    <div id="filePicker">选择图片</div>
                    <input type="hidden" value="${data.background}" id="background" name="background">
                </div>
            </div>
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                [#if colors??]
                    [#list colors as color]
                        <div class="radio-box">
                            <input name="color" type="radio" id="status-${color_index}" value="${color.id}" [#if color.id == data.color] checked[/#if]>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="描述不能为空！" onKeyUp="$.Huitextarealength(this,200)">${data.description}</textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="prerogative" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="描述不能为空！" onKeyUp="$.Huitextarealength(this,200)">${data.prerogative}</textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">微信卡券Id：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span>${data.weixinCardId}</span>
            </div>
        </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">阿里卡券Id：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <span>${data.alipayCardId}</span>
                </div>
            </div>


            <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">专栏：</label>
            <div class="formControls col-xs-8 col-sm-9">
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/topicCard/update.jhtml" ,
                            beforeSend: function() {
