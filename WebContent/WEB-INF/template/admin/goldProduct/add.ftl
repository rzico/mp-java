...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">金币面额：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="gold" value="" placeholder="" id="gold" onInput="intInit(this)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">销售价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="price" value="" placeholder="" id="price" onInput="floatInit(this)">
            </div>
        </div>
        <div class="row cl">
            ...
            $(function(){
                ...
                $("#form-add").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/goldProduct/save.jhtml" ,
                            beforeSend: function() {
