...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员中心 <span
        class="c-gray en">&gt;</span> 投票管理管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div class="page-container">
    <div class=""> 日期范围：
        ...
        <button type="submit" class="btn btn-success radius" id="" onclick="search();" name="">
            <i class="Hui-iconfont">&#xe665;</i> 搜投票管理
        </button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
        <a href="javascript:;" onclick="delAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		<a href="javascript:;" onclick="add('添加投票管理','add.jhtml','','510')" class="btn btn-primary radius"><i
                class="Hui-iconfont">&#xe600;</i> 添加投票管理</a></span></div>
    <div class="mt-20">
        ...
        $('.table').DataTable({
            ...
            "aoColumnDefs": [
                ...
                }, 
                {
                    ...
                    "mRender": function (data, display, row) {
                        if(data != null){
                            return "<a title='编辑' href='javascript:;' onclick=\"edit('编辑投票管理','edit.jhtml?id=" + data + "','200" + data + "','510')\" class=\"ml-5\" style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>" +
