...
<div class="page-container">
    ...
    [#if data??]
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.config.appetAppId}" placeholder="" id="appetAppId" name="appetAppId">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序APPSECRET：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.config.appetAppSerect}" placeholder="" id="appetAppSerect" name="appetAppSerect">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序版本：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.config.version}" placeholder="" id="version" name="version">
            </div>
        </div>
    ...
    $(function(){
        ...
        $("#form-update").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "${base}/admin/smallRange/update.jhtml" ,
                    beforeSend: function() {
