...
<head>
    ...
    <title>ArticleReward</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> ArticleReward <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		...
		<a href="javascript:;" onclick="add('首页 &gt; ArticleReward &gt; 新增','add.jhtml','','510')" class="btn btn-primary radius"><i
                class="Hui-iconfont">&#xe600;</i> 新增ArticleReward</a></span></div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    $(function () {
        $('.table').DataTable({
            ...
            "sAjaxSource": "${base}/admin/articleReward/list.jhtml",
            ...
            "aoColumnDefs": [
                ...
                }, 
                {
                    ...
                    "mRender": function (data, display, row) {
                        if(data != null){
                            return "<a title='编辑' href='javascript:;' onclick=\"edit('首页 &gt; ArticleReward &gt; 编辑','edit.jhtml?id=" + data + "','200" + data + "','510')\" class=\"ml-5\" style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>" +
...
//   表格自适应屏幕
    ...
    /*删除全部*/
    function delAll(){
        var url = "${base}/admin/articleReward/delete.jhtml";
        var i = 0;
    ...
    function del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            ...
            $.ajax({
                ...
                url: '${base}/admin/articleReward/delete.jhtml',
                dataType: 'json',
                success: function (data) {
                    layer.close(load);
                    if (data.type == "success") {
