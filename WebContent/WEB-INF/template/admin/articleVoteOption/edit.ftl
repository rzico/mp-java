...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">VoteOptions：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.voteOptions}" placeholder="" id="voteOptions" name="voteOptions">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Author：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if authors??]
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Options：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.options}" placeholder="" id="options" name="options">
            </div>
        </div>
        <div class="row cl">
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/articleVoteOption/update.jhtml" ,
                            beforeSend: function() {
