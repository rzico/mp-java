...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 文章管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                    ...
                    "mRender": function (data, display, row) {
                        if(data != null){
                            return "<a title='编辑' href='javascript:;' onclick=\"edit('首页 &gt; 文章管理 &gt; 编辑','edit.jhtml?id=" + data + "','200" + data + "','510')\" class=\"ml-5\" style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>" +
                                    ...
                                    "<a title='预览' href='javascript:;' onclick=\"show('" + data + "','http://dev.rzico.com/#/t1001?id=" + data + "','360','400')\" class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe695;</i></a> ";
                        }else{
                            return "";
                        }
                    }
