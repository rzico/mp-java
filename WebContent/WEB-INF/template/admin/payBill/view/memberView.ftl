...
<div class="pd-20">
    <table class="table">
        ...
        [#if member??]
        <tr>
            <th class="text-r" width="120">头像：</th>
            [#if member.logo??]
                <td><img src=${member.logo} width="100" height="100"></td>
            [/#if]
        </tr>
        <tr>
            <th class="text-r" width="120">昵称：</th>
            [#if member.nickName??]
        ...
        <tr>
            <th class="text-r" width="120">签名：</th>
            [#if member.autograph??]
                <td>${member.autograph}</td>
            [/#if]
        </tr>
        <tr>
            <th class="text-r" width="120">职业：</th>
            [#if types??]
        ...
        <tr>
            <th class="text-r" width="120">电话：</th>
            [#if member.phone??]
                <td>${member.phone}</td>
            [/#if]
        </tr>
        ...
        <tr>
            <th class="text-r" width="120">积分：</th>
            [#if member.point??]
                <td>${member.point}</td>
            [/#if]
        </tr>
        ...
        <tr>
            <th class="text-r" width="120">邮编：</th>
            [#if member.zipCode??]
                <td>${member.zipCode}</td>
            [/#if]
        </tr>
        <tr>
            <th class="text-r" width="120">所在地：</th>
            [#if types??]
                [#list areas as area]
        ...
        <tr>
            <th class="text-r" width="120">连续登录失败次数：</th>
