    ...
    <form action="" method="post" class="form form-horizontal" id="form-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="allocatedStock" value="" placeholder="" id="allocatedStock" onInput="intInit(this)">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="stock" value="" placeholder="" id="stock" onInput="intInit(this)">
            </div>
        </div>
            ...
            $(function(){
                ...
                $("#form-add").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/productStock/save.jhtml" ,
                            beforeSend: function() {
