...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        [#if data??]
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Quantity：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.quantity}" placeholder="" id="quantity" name="quantity" onInput="intInit(this)">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Cart：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if carts??]
				<select name="cartId" class="select" style="background-color: #FFFFFF">
                    [#list carts as cart]
					<option[#if data.cart?? && cart.id == data.cart.id] selected[/#if] value="${cart.id}">${cart.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Product：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if products??]
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Seller：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if sellers??]
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/cartItem/update.jhtml" ,
                            beforeSend: function() {
