...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        [#if data??]
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>号码：</label>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                    <input type="checkbox" name="isUsed" id="isUsed" value="true"[#if data.isUsed?? && data.isUsed] checked[/#if]>
                    <input type="hidden" name="_isUsed" value="false" />
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss' })" value="${data.usedDate}" id="usedDate" name="usedDate" class="input-text Wdate" style="width:180px;">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>优惠券：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                [#if coupons??]
				<select name="couponId" class="select" style="background-color: #FFFFFF">
                    [#list coupons as coupon]
					<option[#if data.coupon?? && coupon.id == data.coupon.id] selected[/#if] value="${coupon.id}">${coupon.name}</option>
                    [/#list]
				</select>
                [/#if]
				</span>
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/couponCode/update.jhtml" ,
                            beforeSend: function() {
