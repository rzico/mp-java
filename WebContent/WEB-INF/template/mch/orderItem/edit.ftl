...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-update">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.returnQuantity}" placeholder="" id="returnQuantity" name="returnQuantity" onInput="intInit(this)">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${data.shippedQuantity}" placeholder="" id="shippedQuantity" name="shippedQuantity" onInput="intInit(this)">
            </div>
        </div>
            ...
            $(function(){
                ...
                $("#form-update").validate({
                    ...
                    submitHandler:function(form){
                        ...
                        $(form).ajaxSubmit({
                            type: 'post',
                            url: "${base}/admin/orderItem/update.jhtml" ,
                            beforeSend: function() {
