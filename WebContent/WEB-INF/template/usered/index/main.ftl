    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">${setting.siteName}</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">${principal.username}<i class="Hui-iconfont">&#xe6d5;</i></a>
                    </li>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="/usered/index/index.jhtml">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="/usered/index/index.jhtml"></iframe>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    ...
    /*切换账号*/
    function login(){
        location.href = "/usered/login/index.jhtml";
    }
    /*退出账户*/
    function logout(){
        $.ajax({
            url: "${base}/usered/login/logout.jhtml",
            type: "GET",
            cache: false,
