...
public class ProductStockDaoImpl extends BaseDaoImpl<ProductStock, Long> implements ProductStockDao {
	/**
	 * @Title：findPage
	 * @Description：标准代码
	 * @param beginDate
	...
	public Page<ProductStock> findPage(Date beginDate,Date endDate, Pageable pageable) {
		...
		CriteriaQuery<ProductStock> criteriaQuery = criteriaBuilder.createQuery(ProductStock.class);
		Root<ProductStock> root = criteriaQuery.from(ProductStock.class);
