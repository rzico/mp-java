...
public class ReturnsItemDaoImpl extends BaseDaoImpl<ReturnsItem, Long> implements ReturnsItemDao {
	 ...
	 * @param endDate
	 * @param pageable
	 * @return Page<ReturnsItem>
	 */
	public Page<ReturnsItem> findPage(Date beginDate,Date endDate, Pageable pageable) {
		CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
		CriteriaQuery<ReturnsItem> criteriaQuery = criteriaBuilder.createQuery(ReturnsItem.class);
		Root<ReturnsItem> root = criteriaQuery.from(ReturnsItem.class);
