...
@Repository("counselorDaoImpl")
public class CounselorDaoImpl extends BaseDaoImpl<Counselor, Long> implements CounselorDao {
	/**
	 * @Title：findPage
	 * @Description：标准代码
	 * @param beginDate
	...
	public Page<Counselor> findPage(Date beginDate,Date endDate, Pageable pageable) {
		...
		Root<Counselor> root = criteriaQuery.from(Counselor.class);
