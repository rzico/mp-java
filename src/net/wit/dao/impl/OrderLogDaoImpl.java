...
public class OrderLogDaoImpl extends BaseDaoImpl<OrderLog, Long> implements OrderLogDao {
	 ...
	 * @param endDate
	 * @param pageable
	 * @return Page<OrderLog>
	 */
	public Page<OrderLog> findPage(Date beginDate,Date endDate, Pageable pageable) {
		CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
		CriteriaQuery<OrderLog> criteriaQuery = criteriaBuilder.createQuery(OrderLog.class);
		Root<OrderLog> root = criteriaQuery.from(OrderLog.class);
