...
@Repository("articleReviewDaoImpl")
public class ArticleReviewDaoImpl extends BaseDaoImpl<ArticleReview, Long> implements ArticleReviewDao {
	...
	public Page<ArticleReview> findPage(Date beginDate,Date endDate, Pageable pageable) {
		...
		CriteriaQuery<ArticleReview> criteriaQuery = criteriaBuilder.createQuery(ArticleReview.class);
		Root<ArticleReview> root = criteriaQuery.from(ArticleReview.class);
