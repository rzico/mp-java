...
public class Auth2Controller extends BaseController {
    ...
    DataBlock getToken(HttpServletRequest request) {
        ...
        String token = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<token code=\"0000\" msg=\"success\"> <userInfo>" + "<userId>" + String.format("%036d", member.getId()) + "</userId>" + "<account>" + member.getMobile() + "</account>" + "<username>"
