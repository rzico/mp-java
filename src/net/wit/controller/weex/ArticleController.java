...
public class ArticleController extends BaseController {
    ...
    @ResponseBody
    public Message list(Long authorId, Boolean isTop, Long tagId, Long articleCategoryId, Long articleCatalogId, Article.ArticleType mediaType, Pageable pageable, HttpServletRequest request){
