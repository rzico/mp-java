...
/**
 * @ClassName: WeexRewardController
 * @author 降魔战队
 * @date 2017-9-14 19:42:9
 */
 
@Controller("weexRewardController")
@RequestMapping("/weex/reward")
public class RewardController extends BaseController {
    ...
    public Message list(Long articleId, Pageable pageable, HttpServletRequest request){
        ...
        filters.add(new Filter("status", Filter.Operator.eq,ArticleReward.Status.success));
