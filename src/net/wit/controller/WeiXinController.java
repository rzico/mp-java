...
import net.wit.plat.weixin.FormEntity.WeixinAccountEntity;
...
public class WeiXinController extends BaseController {
    ...
    private WeixinAccountEntity weixinAccountEntity;
...
//        }
        try {
            System.out.println(appId+"进入/{appId}/notify  POST+++++++++++++++++++++++++++++++++");
    ...
    public void output(HttpServletResponse response,String returnvaleue){
        try {
            System.out.println("--------------------response开始返回数据给微信端-----------------");
            PrintWriter pw = response.getWriter();
            pw.write(returnvaleue);
            pw.flush();
            System.out.println("--------------------response返回数据完成,真~~~~~结束-----------------");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void replyApiTextMessage(HttpServletRequest request, HttpServletResponse response, String auth_code, String fromUserName, String appid) {
        ...
        try {
            ...
            String conToken = ArticlePropa.getComponentToken(COMPONENT_APPID,COMPONENT_SECRET,weixinAccountEntity.getComponentVerifyTicket());
    ...
    void processAuthorizationEvent(String xml){
        ...
        try {
            ...
            if(ticket!=null&&!ticket.equals("")){
                ...
                weixinAccountEntity.setAppId(appId);
                weixinAccountEntity.setCreateTime(createTime);
                weixinAccountEntity.setComponentVerifyTicket(ticket);
                weixinAccountEntity.setInfoType(infoType);
            }
