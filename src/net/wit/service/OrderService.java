...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 订单
	 */
	Order build(Member member ,Product product, Integer quantity, Cart cart, Receiver receiver,String memo, Long promotionId, Order.ShippingMethod shippingMethod,Dragon dragon);
	 ...
	 * @return 订单
	 */
	Order create(Member member ,Product product, Integer quantity, Cart cart, Receiver receiver, String memo,Long xuid, Admin operator, Long promotionId, Order.ShippingMethod shippingMethod,Dragon dragon,Date hopeDate,Boolean offline);
