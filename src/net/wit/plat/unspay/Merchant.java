...
public class Merchant {
    ...
    public static void editMerchant(net.wit.entity.Merchant merchant) throws Exception{
        Map<String,Object> body = new HashMap<String,Object>();
        body.put("scompany",merchant.getScompany());
        body.put("merchantName",merchant.getMerchantName());
        body.put("phone",merchant.getPhone());
        ...
        String reqUrl = "http://180.166.114.152:18082/small_qrcode_pro/edit/editMerchant.do";
