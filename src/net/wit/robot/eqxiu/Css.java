...
public class Css {
    ...
    public void setBorderRadiusPerc(int borderRadiusPerc) {
        this.borderRadiusPerc = borderRadiusPerc;
    }
    public int getBorderRadiusPerc() {
        return borderRadiusPerc;
    }
    ...
    public void setBoxShadowDirection(int boxShadowDirection) {
        this.boxShadowDirection = boxShadowDirection;
    }
    public int getBoxShadowDirection() {
        return boxShadowDirection;
    }
