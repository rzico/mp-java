...
<title>${message("admin.plugin.oss.setting")} - Powered By rsico</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr> 
				<th>
					<span class="requiredField">*</span>endpoint:
				</th>
				<td>
					<input type="text" name="endpoint" class="text" value="${pluginConfig.attributes['endpoint']}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="isCorpEnabled" value="true"[#if pluginConfig.attributes['isCorpEnabled']=="true"] checked[/#if] />
					</label>
				</td>
			</tr>
			<tr>
