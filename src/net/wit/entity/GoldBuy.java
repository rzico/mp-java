 ...
 */
@Entity
@Table(name = "gm_gold_buy")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "gm_gold_buy_sequence")
public class GoldBuy extends BaseEntity {
	...
	/** 支付金额 */
	@Column(columnDefinition="decimal(21,6) not null comment '支付金额'")
